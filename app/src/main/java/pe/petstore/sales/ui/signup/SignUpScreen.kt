package pe.petstore.sales.ui.signup
...
import pe.petstore.sales.ui.theme.SelectedField
import pe.petstore.sales.ui.theme.UnselectedField
        ...
        Button(onClick = {
            auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    Log.i("Sign Up", "Registro OK")
                } else {
                    Log.i("Sign Up", "Registro KO")
                }
            }
        }) {
            Text(text = "Sign Up")
